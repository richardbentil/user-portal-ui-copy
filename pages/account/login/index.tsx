                      ...
                      {error && <p className="text-danger">Error: {error}</p>}
                        ...
                        >
                          {({ isSubmitting }) => (
                            ...
                            <div className="relative d-flex align-items-center justify-content-center my-1 my-xl-0 my-xxl-2">
                              <hr className="h-2px w-100" />
                              <p className="shrink-0 text-center text-uppercase text-muted px-3 text-nowrap">or</p>
                              <hr className="h-2px w-100" />
                            </div>
                                  <div className="d-grid gap-4 mb-3 my-xl-2 my-xxl-3">
                                    <button
                                      onClick={handleAouth}
                        ...
                        <p className="mt-4 mb-4 my-xl-4 mb-xxl-5 text-center">
